...
module.exports.sockets = {
  ...
  */
  ...
  // to speed up the serving of the static pictures.
  ...
  // Does Socket.IO need to GZIP the static pictures?
  ...
  // Optional override function to serve all static pictures,
  // including socket.io.js et al.
  // Of the form :: function (req, res) { /* serve pictures */ }
